...
# creating an intercative enviroment using python & pylint for checking spellings and namecase handling

states = {
    "Alabama": {"capital": "Montgomery", "state_bird": "Yellowhammer", "state_flower": "Camellia",
                "population": "4908620"},
    "Alaska": {"capital": "Juneau", "state_bird": "Willow Ptarmigan", "state_flower": "Forget Me Not",
               "population": "734002"},
    "Arizona": {"capital": "Phoenix", "state_bird": "Cactus Wren", "state_flower": "Saguaro Cactus Blossom",
                "population": "7378490"},
    "Arkansas": {"capital": "Little Rock", "state_bird": "Mockingbird", "state_flower": "Apple Blossom",
                 "population": "3039000"},
    "California": {"capital": "Sacramento", "state_bird": "California Valley Quail",
                   "state_flower": "California Poppy", "population": "39937500"},
    "Colorado": {"capital": "Denver", "state_bird": "Lark Bunting", "state_flower": "White and Lavender Columbine",
                 "population": "5845530"},
    "Connecticut": {"capital": "Hartford", "state_bird": "Robin", "state_flower": "Mountain Laurel",
                    "population": "3563080"},
    "Delaware": {"capital": "Dover", "state_bird": "Blue Hen", "state_flower": "Peach Blossom", "population": "982895"},
    "Florida": {"capital": "Tallahassee", "state_bird": "Mockingbird", "state_flower": "Orange Blossom",
                "population": "21993000"},
    "Georgia": {"capital": "Atlanta", "state_bird": "Mockingbird", "state_flower": "Orange Blossom",
                "population": "10736100"},
...
def search():  # handles searching through the dictionary all the states
...
def show():  # handles showing all the states
    frame = pd.DataFrame(states)
    print(frame)
    main()


def update():  # handles searching and updating the specific value given
    print("\n ---- Updating ---- \n")
